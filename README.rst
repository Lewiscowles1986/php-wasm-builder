...
This branch built the PHP5.4, PHP5.5 and PHP5.6 on https://lewiscowles1986.github.io/experiments/wasm/php/
...
My Scope is smaller than Derick Rethans, the original author of this repo.

I also do not plan to integrate all the branches. For me the fact the artifact,
has a common interface is enough for now. PHP5.4, 5.5 and 5.6 are basically a decade out of date now...
